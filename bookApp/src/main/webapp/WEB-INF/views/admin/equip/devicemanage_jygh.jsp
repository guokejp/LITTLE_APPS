...
<html>
  	...
  	<body>
		...
		<div class="modal fade addPartModal" id="fjxt_addpart">
			<div class="modal-dialog  modal-lg">
				<div class="modal-content">
						...
						<form enctype="multipart/form-data" id="formUpload">
							<table class="table	table-bordered gui-table-box">
								...
								<tr>
									...
									<td class="special-margin" colspan="3"><label id="fatherEquipName" style="padding: 0 10px;"></label></td>
								</tr>
								<tr>
					...
					<div class="modal-footer">
						<button type="button" class="btn gui-btn-ok" id="addPartBtn">添加设备</button>
						<button type="button" class="btn gui-btn-cancel" data-dismiss="modal">取消</button>
					</div>
				</div>
			</div>
					...
					<div class="modal-body fjxt_modal_body">
						<form enctype="multipart/form-data" id="formUpload">
							<table class="table	table-bordered gui-table-box">
								<tbody>
								<tr>
									<td class="table-label"><label>图书编号：</label></td>
								...
								<tr>
									...
									<td><input type="text" class="form-control" id='bowrbookunit' name="bowrbookunit" placeholder="请输入"></td>
									<td class="table-label">借阅人名字：</td>
									<td><input type="text" class="form-control" id='bowrbookispecific' name="bowrbookispecific"  placeholder="请输入"></td>
									
								</tr>
								<tr>
									<td class="table-label">借阅人电话：</td>
									<td><input type="text" class="form-control" name="bowrbookibrand" id="bowrbookibrand" placeholder="请输入"></td>
									<td colspan="4" class="text-center">
										<input type="text" name="bowrbookspotlocate" id="spotlocate1" class="spotlocate" value="">
										<span class="btn gui-btn-view" id="pointImg" onclick="parentFunction();">借阅人住址</span>
									</td>
								</tr>
								</tbody>
		...
		<script src="views/admin/equip/devicemanage_jygh.js"></script>
		...
		<script type="text/javascript">
            ...
            function backParameters() {
                ...
                if(parentValue !== ''){
                    ...
                    $("#spotlocate1").val(newValue[0]+","+newValue[1]);
                }
            }
		</script>
	</body>
