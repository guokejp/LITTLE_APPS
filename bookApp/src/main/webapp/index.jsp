...
<body>
        ...
        <div class="layui-header header">
            <div class="layui-main">
                <a class="logo" href="index.jsp">
                    ...
                    <span class="logo-title" style="font-size:11">图书管理系统</span>
                </a>
    ...
    <script>
    	...
    	function getmap(x,y){
    		x= (x!=undefined && !isNaN(x)) ? x : 116.397428;
    		y= (y!=undefined && !isNaN(y)) ? y : 39.90923;
    		...
    		map.on('click', function(e) {
            	...
            	$("#spotlocate1").val(e.lnglat.getLng()+","+e.lnglat.getLat());
            });
    		return map;
    	}
        // 实例化点标记
        ...
        function showIframeModal(option) {
            ...
            x= (x!=undefined && !isNaN(x) && x!="") ? x : 116.397428;
    		y= (y!=undefined && !isNaN(y) && y!="") ? y : 39.90923;
