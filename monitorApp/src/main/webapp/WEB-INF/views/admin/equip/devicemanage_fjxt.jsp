					...
					<div class="modal-body fjxt_modal_body">
						<form enctype="multipart/form-data" id="formUpload">
							<table class="table	table-bordered gui-table-box">
								...
								<tr>
									<td class="table-label"><label>规格型号：</label></td>
									<td><input type="text" class="form-control" name="ispecific"  placeholder="请输入"></td><td class="table-label"><label>状态：</label></td>
									<td><input type="text" class="form-control" name="istatus" id="add_status" disabled></td>
								</tr>
								<tr>
									
									<td class="table-label">安装时间：</td>
								...
								<tfoot>
									...
									<tr>
										<td colspan="4" class="text-center">
											...
											<span class="btn gui-btn-view" id="pointImg" onclick="parentFunction();">定位</span>
										</td>
									</tr>
								</tfoot>
							</table>
				...
				<div class="modal-content">
					...
					<div class="modal-body fjxt_modal_body">
						<table class="table	table-bordered gui-table-box">
							...
							--%>
							<tr>
								<td class="table-label"><label>安装位置：</label></td>
								<td><label name="ibrand" type="data" ></label></td>
								<td class="table-label"><label>品牌：</label></td>
								<td><label name="unit" type="data" ></label></td>
							</tr>
							<tr>
								<td class="table-label"><label>上线时间：</label></td>
							...
							<tr>
								<td colspan="4" class="text-center">
									<input type="text" name="spotlocate" id="spotlocate" class="spotlocate" value="">
									<span class="btn gui-btn-view" id="pointImg" onclick="parentFunction('y');">定位</span>
								</td>
							</tr>
							</tfoot>
						</table>
